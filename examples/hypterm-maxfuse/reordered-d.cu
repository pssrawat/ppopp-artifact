...
_t_9_ -= q_4[k][j][i-4];
_t_5_ -= 0.0035 * _t_9_;
double flux_1kc0jc0ic0 = _t_5_ * dxinv0;
...
double flux_2kc0jc0ic0 = _t_10_ * dxinv0;
...
double flux_3kc0jc0ic0 = _t_15_ * dxinv0;
...
double flux_4kc0jc0ic0 = _t_20_ * dxinv0;

double _t_27_ = cons_2[k][j+1][i];
_t_27_ -= cons_2[k][j-1][i];
double _t_26_ = 0.8 * _t_27_;
