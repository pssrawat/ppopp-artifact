...
extern "C" void j2d81pt_gold (double*, double*, int);
...
int main(int argc, char** argv) {
  ...
  j2d81pt_gold((double*)input, (double*)output_gold, N);

  double error = checkError2D<double> (N, (double*)output, (double*) output_gold, 0, N-8, 0, N-8);
