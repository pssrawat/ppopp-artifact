...
#pragma unroll 4
		for (int jj=0; jj<=3; jj++) {
			out[k][j+jj][i] =
			0.75 * (in[k-2][j+jj-2][i-2] + in[k-2][j+jj-2][i+2] + in[k-2][j+jj+2][i-2] + in[k-2][j+jj+2][i+2] + in[k-1][j+jj-1][i-1] + in[k-1][j+jj-1][i+1] + in[k-1][j+jj+1][i-1] + in[k-1][j+jj+1][i+1] + 
			...
			0.76 * (in[k-2][j+jj-2][i-2] + in[k-2][j+jj-2][i+2] + in[k-2][j+jj+2][i-2] + in[k-2][j+jj+2][i+2]) + 

			1.132 * (in[k-2][j+jj-2][i-1] + in[k-2][j+jj-2][i+1] + in[k-2][j+jj-1][i-2] + in[k-2][j+jj-1][i+2] + in[k-2][j+jj][i] + in[k-2][j+jj+1][i-2] + in[k-2][j+jj+1][i+2] + in[k-2][j+jj+2][i-1] +  in[k-2][j+jj+2][i+1] +
			...
			in[k+1][j+jj-2][i-2] + in[k+1][j+jj-2][i+2] + in[k+1][j+jj+2][i-2] + in[k+1][j+jj+2][i+2] + 
			in[k-2][j+jj-2][i-1] + in[k-2][j+jj-2][i+1] + in[k-2][j+jj-1][i-2] + in[k-2][j+jj-1][i+2] + in[k-2][j+jj][i] + in[k-2][j+jj+1][i-2] + in[k-2][j+jj+1][i+2] + in[k-2][j+jj+2][i-1] +  in[k-2][j+jj+2][i+1]) +
			...
			in[k][j+jj-2][i-1] + in[k][j+jj-2][i+1] + in[k][j+jj-1][i-2] + in[k][j+jj-1][i+2] + in[k][j+jj][i] + in[k][j+jj+1][i-2] + in[k][j+jj+1][i+2] + in[k][j+jj+2][i-1] +  in[k][j+jj+2][i+1] +
			in[k+1][j+jj-2][i] + in[k+1][j+jj][i-2] + in[k+1][j+jj][i+2] + in[k+1][j+jj+2][i] +  
			...
			in[k-1][j+jj-2][i-1] + in[k-1][j+jj-2][i+1] + in[k-1][j+jj-1][i-2] + in[k-1][j+jj-1][i+2] + in[k-1][j+jj][i] + in[k-1][j+jj+1][i-2] + in[k-1][j+jj+1][i+2] + in[k-1][j+jj+2][i-1] +  in[k-1][j+jj+2][i+1] +
			in[k][j+jj-1][i-1] + in[k][j+jj-1][i+1] + in[k][j+jj+1][i-1] + in[k][j+jj+1][i+1] + 
			in[k+1][j+jj-2][i-1] + in[k+1][j+jj-2][i+1] + in[k+1][j+jj-1][i-2] + in[k+1][j+jj-1][i+2] + in[k+1][j+jj][i] + in[k+1][j+jj+1][i-2] + in[k+1][j+jj+1][i+2] + in[k+1][j+jj+2][i-1] +  in[k+1][j+jj+2][i+1]) +
			0.332 * (in[k-2][j+jj-1][i-1] + in[k-2][j+jj-1][i+1] + in[k-2][j+jj+1][i-1] + in[k-2][j+jj+1][i+1]); 
		}
	}
}
