...
double outkc0jc0ic0 = 1.132 * in[k-1][j-2][i-2];
...
double outkc0jp1ic0 = 0.331 * in[k-1][j-1][i-1];
outkc0jc0ic0 += 0.75 * in[k-1][j-1][i+1];
outkc0jp1ic0 += 0.331 * in[k-1][j-1][i+1];
outkc0jc0ic0 += 0.75 * in[k-1][j+1][i-1];
outkc0jp1ic0 += 0.217 * in[k-1][j+1][i-1];
double outkc0jp2ic0 = 0.75 * in[k-1][j+1][i-1];
double outkc0jp3ic0 = 0.331 * in[k-1][j+1][i-1];
outkc0jc0ic0 += 0.75 * in[k-1][j+1][i+1];
outkc0jp1ic0 += 0.217 * in[k-1][j+1][i+1];
